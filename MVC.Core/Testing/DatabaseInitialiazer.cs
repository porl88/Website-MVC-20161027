namespace MVC.Core.Testing
{
    ...
    public class DatabaseInitializer : DropCreateDatabaseAlways<WebsiteDbContext>
    {
        protected override void Seed(WebsiteDbContext context)
        {
            ...
            //context.ArticleVersions.Add(articleVersion);
            ...
            //{
            //	Title = "Lorem Ipsum",
            //	Summary = "Lorem ipsum dolor sit amet, admodum sapientem ne duo. Ex quo mentitum similique, eu nec eirmod euismod. His possit salutandi id, ex nostrum recusabo reprimique pri. Cu pri modus percipit, vis ad moderatius scribentur.",
            ...
            //	Summary = "Eurotunnel says it expects to resume some vehicle and freight services through the Channel Tunnel on Saturday night following a lorry fire.",
